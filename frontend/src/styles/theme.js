...
export const surf2 = 'bg-orange-50 dark:bg-[#1a1d2e]';
export const surf3 = 'bg-gray-50 dark:bg-[#1e2235]';
export const bord  = 'border-orange-100 dark:border-[#1e2235]';
export const bord2 = 'border-orange-200 dark:border-[#2a2d3e]';
...
// Card
export const card  = `bg-white dark:bg-[#13151f] border border-orange-100 dark:border-[#1e2235] rounded-2xl`;
export const card2 = `bg-orange-50 dark:bg-[#1a1d2e] border border-orange-100 dark:border-[#2a2d3e] rounded-2xl`;

// Input
export const inp = [
  'w-full rounded-xl px-4 py-2.5 text-sm transition-all',
  'bg-white dark:bg-[#1a1d2e]',
  'border border-orange-200 dark:border-[#2a2d3e]',
  'text-gray-900 dark:text-gray-100',
  'placeholder-gray-400 dark:placeholder-gray-600',
  'focus:outline-none focus:ring-2 focus:ring-orange-400/40 dark:focus:ring-orange-500/30',
  'focus:border-orange-400 dark:focus:border-orange-500/60',
].join(' ');
...
export const btnSecondary = [
  ...
  'hover:bg-orange-50 dark:hover:bg-[#1a1d2e]',
...
export const STATUS = {
  ...
  review:    { bg: 'bg-orange-50 dark:bg-orange-500/10', border: 'border-orange-200 dark:border-orange-500/20', text: 'text-orange-600 dark:text-orange-400', dot: 'bg-orange-500' },
