const STATUS_MAP = {
  ...
  PENDING_MANAGER_APPROVAL: { label: 'Pending Manager',    cls: 'bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/20' },
  MANAGER_APPROVED:         { label: 'Manager Approved',   cls: 'bg-teal-50 dark:bg-teal-500/10 text-teal-600 dark:text-teal-400 border-teal-200 dark:border-teal-500/20'       },
  ...
  REJECTED:                 { label: '✕ Rejected',         cls: 'bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 border-red-200 dark:border-red-500/20'             },
  FINANCE_REJECTED:         { label: '✕ Finance Rejected', cls: 'bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 border-red-200 dark:border-red-500/20'             },
  NEEDS_REVIEW:             { label: 'Needs Review',       cls: 'bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/20' },
